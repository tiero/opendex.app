...
const getSwapType = (sendCurrency, receiveCurrency) => {
  const sendingOnLightning =
    sendCurrency.swapValues.type === CurrencyTypes.Lightning;
  const receiveOnLightning =
    receiveCurrency.swapValues.type === CurrencyTypes.Lightning;
