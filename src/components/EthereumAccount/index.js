    ...
    <div className={classes.ethereumWrapper}>
      ...
      {error && (
        <div className={classes.errorLabel}>
          You do not have enough Ether to pay for the miner fee required claim
          the USDT of the Swap.
          <br />
          Therefore, we will show you a second invoice and after both are paid,
          the coins for the Swap will get locked and you will have some Ether in
