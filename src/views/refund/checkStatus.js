...
import { Typography, Button, Divider, TextareaAutosize } from '@material-ui/core';
...
import { selectSwapId, selectETA, selectFileDetails, selectTransactionHash } from '../../services/refund/refundSelectors';
...
const Status = ({ handleNextStep, handlePrevStep }) => {
    ...
    const needAddressInput = refundFile.type !== CurrencyTypes.Ether && refundFile.type !== CurrencyTypes.ERC20;
    ...
    return (<div className="refund__check-status">
            ...
            {
                etaLeft > 0 ? <div className="sub-heading">Expires in {etaTimeDiffLabel || etaLabel}</div> : null
            }
            ...
            </div>
            {
                needAddressInput ? 
                    <div className={'address-wrapper'}>
                        <div>
                            {addressNetwork} destination address
                        </div>
                        <TextareaAutosize
