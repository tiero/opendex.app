      ...
      if (
        ...
        signer.provider.getBlockNumber().then(blockNumber => {
          ...
          if (timelock > blockNumber) {
            const timeoutDeltaSeconds =
              (timelock - blockNumber) * blockTimes.Ethereum;
  ...
  const renderHeader = () => (
    ...
    >
      ...
      <Typography variant="div" align="center" className="sub-heading">
        If your on-chain to lightning swap didn't succeed for some reason,
        please upload the refund file you downloaded to check status and start
