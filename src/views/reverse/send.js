...
import { selectReverseSwapDetails, selectEthereumPrepayMinerFeePaid } from '../../services/reverse/reverseSelectors';
import { selectReceiveCurrency, selectSendCurrency, selectSwapStatus } from '../../services/submarine/submarineSelectors';
...
const Send = () => {
    ...
    const ethereumPrepayMinerFeePaid = useSelector(selectEthereumPrepayMinerFeePaid);
    ...
    const invoice = !ethereumPrepayMinerFeePaid && swapDetails.minerFeeInvoice !== undefined ?
        swapDetails.minerFeeInvoice : swapDetails.invoice;
    ...
    return (
        <Invoice
            ...
            lockupLink={getBlockExplorerLink(receiveCurrency.symbol, swapDetails.lockupAddress)}
        />
    );
};
